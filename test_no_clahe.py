...
def run_no_clahe_benchmark(limit_per_emotion=10):
    print(f"--- No-CLAHE Accuracy Check (Limit: {limit_per_emotion}/emotion) ---")
    ...
    for emotion in EMOTIONS:
        ...
        for f in files:
            ...
            # NO CLAHE
            resized = cv2.resize(frame, (48, 48)).astype("float32") / 255.0
    ...
    print("\n" + "="*30)
    print(f"NO-CLAHE TOTAL ACC: {(correct/total)*100:.2f}%")
    print("="*30)
